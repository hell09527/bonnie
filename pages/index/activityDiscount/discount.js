...
Page({
  ...
  data: {
    ...
    aClickFlag: 0,
    titleImg:[
      "https://static.bonnieclyde.cn/WechatIMG19.jpeg",
      "https://static.bonnieclyde.cn/WechatIMG20.jpeg",
      "https://static.bonnieclyde.cn/WechatIMG21.jpeg",
    ],
      ...
      success: function (res) {
        ...
        if (code == 0) {
          ...
          for (let index in goods_list){
            ...
            goods_list[index].market_price = parseFloat(goods_list[index].market_price)
            goods_list[index].promotion_price = parseFloat(goods_list[index].promotion_price)
          }
          ...
          var result = [];
          for (var i = 0, len = goods_list.length; i < len; i += 3) {
            result.push(goods_list.slice(i, i + 3));
          }
          console.log(goods_list,result)
  ...
  handletouchmove: function (event) {
    ...
    if (touchMove < event.touches[0].clientY) {
      // console.log("向下滑了");
      this.setData({
        isFix: 1,
      })
